...
def execute_query(input_post_file, input_query_file, output_file, term_dict, docs_dict, doc_fields_dict):
    ...
    non_rel_len = int(len(vsm_results) * pseudo_non_relevance_threshold)
    non_relevant_documents = list((set(docs_dict.keys()) - set(vsm_results)) | set(vsm_results[-non_rel_len:]))
...
if __name__ == "__main__":
    ...
    for o, a in opts:
        if o == '-d':
            ...
            pseudo_relevance_threshold = int(a)
        elif o == '-v':
