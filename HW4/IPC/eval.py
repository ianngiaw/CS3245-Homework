...
for i in range(5, 31, 1):
	i = float(i) / 10.0
	subprocess.call(["python","search.py","-d","d.txt","-p","p.txt","-q","../q1.xml","-o","o1.txt","-i",str(i)])
	subprocess.call(["python","search.py","-d","d.txt","-p","p.txt","-q","../q2.xml","-o","o2.txt","-i",str(i)])
	# Evaluate query 1
	...
	results.append((total_average_f2, q1_average_f2, q2_average_f2, i))
